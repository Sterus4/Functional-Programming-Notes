...
Golden тестирование чем то похоже на Doctest. Суть метода также проста: давайте будем сохранять ***золотой*** вариант работы нашей программы, с которым в будущем мы сможем сравнивать последующие, измененные версии программы.
